...
create assembly [mssql.extensions.string] from N'C:\storage\ssd01\app\sql\bi_dev.sql.mssql.extensions\bi_dev.sql.mssql.extensions.string\bin\Debug\bi_dev.sql.mssql.extensions.@string.dll' with permission_set = unsafe;
go
